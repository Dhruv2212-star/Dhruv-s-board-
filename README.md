...
6. **Block 6 — GPIO Expansion**  
   ...
   1. Block 1 — USB Power Input & Protection: Provide safe 5 V input from a USB-C connector and protect the board against faults before supplying the voltage regulator   
...
2. Block 2 — 3.3 V Power Supply: Convert USB 5 V into a stable 3.3 V supply for the STM32 and peripherals  
   | Ref | Component        | Why it was used                                                    | Function                                                      |
| --- | ---------------- | ------------------------------------------------------------------ | ------------------------------------------------------------- |
